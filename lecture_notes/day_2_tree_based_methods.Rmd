...
We're going to use the [Online News Popularity Data Set from the UCI Machine Learning] Repository(https://archive.ics.uci.edu/ml/datasets/Online+News+Popularity). The target is the number of shares (`shares`). Here I'm dealing with quick data wrangling to get the data ready for modeling.
